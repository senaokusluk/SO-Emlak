...
namespace EmlakOtomasyonu
{
    public partial class GayrimenkulForm : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source=SENA; initial Catalog=EmlakOtomasyonu; Integrated Security=true");
        ...
        private void txtMustakilBaslik_TextChanged(object sender, EventArgs e)
        {
